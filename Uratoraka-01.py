...
def reward_function(params):
    ...
    if speed < 1.0:
        return 0.001
    elif (speed >= 1.0 and speed < 2.0):
        speedReward += 1 # reward additional 1 point if the speed is between 1.0 m/s and 1.99 m/s
    elif (speed >= 2.0 and speed < 3.0):
        speedReward += 5 # reward additional 5 points if the speed is between 2.0 m/s and 2.99 m/s
    elif (speed >= 3.0 and speed <= 4.0):
        speedReward += 10 # reward additional 10 points if the speed is between 3.0 m/s and 4.0 m/s
